<script lang="ts">
	...
	let creatorDialogue: Message[] = [
		...
		{ type: "text", text: "Good, now disribute your skill points as you see fit. It is probably easier if you keep it a relatively even spread but don't let me stop you.", from: alice, next: 2 },
		...
		{ type: "text", text: "Strength increase your damage with physical weapons or using brute force to help you on your journey.", from: alice, next: 3 },
		{ type: "text", text: "Dexterity allows you easily dodge attacks or traps along with crafting handy items.", from: alice, next: 3 },
		{ type: "text", text: "Intelligence allows you to come up with new creative ways to tackle a problem ahead of you.", from: alice, next: 3 },
		{ type: "text", text: "Vitality allows you to take more of a beating in combat", from: alice, next: 3 },
		{ type: "text", text: "Charisma allows you to manipulate people to align with your goals and whims.", from: alice, next: 3 },
...
<div class="container-fluid p-0">
	...
	{#if !tutorialCompleted}
		...
		{#key msgs}
			<Dialogue bind:msgs={activeDialogue} player={you} onEnd={onTutorialEnd}>
				{#snippet leftCol()}
					{#if tutorialStage === 2}
						<div class="col-xl-6">
							<Creator />
